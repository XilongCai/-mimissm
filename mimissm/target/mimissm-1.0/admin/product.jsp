...
<div id="brall">
    ...
    <div id="condition" style="text-align: center">
        <form id="myform">
            商品名称：<input name="pname" id="pname" onchange="condition()">
            商品类型：<select name="typeid" id="typeid" onchange="condition()">
            <option value="-1">请选择</option>
            <c:forEach items="${typeList}" var="pt">
                <option value="${pt.typeId}">${pt.typeName}</option>
            </c:forEach>
        </select>&nbsp;&nbsp;&nbsp;
            价格：<input name="lprice" id="lprice" onchange="condition()">-<input name="hprice" id="hprice" onchange="condition()">
...
// alert(str+"11111111");
    ...
    function one(pid, ispage) {
        ...
        var lprice = $("#lprice").val();
        var hprice = $("#hprice").val();
        var str = "?pid=" + pid + "&page=" + ispage + "&pname=" + pname + "&typeid=" + typeid + "&lprice=" + lprice
            + "&hprice=" + hprice;
